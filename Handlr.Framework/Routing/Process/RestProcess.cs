...
namespace Handlr.Framework.Routing.Process
{
    ...
    /// </summary>
    [Tag("Definition")]
    public class RestProcess : IProcess<RestFieldCache, RestProcessLoaderArguments, RestInput, RestOutput>
    {
        /// <summary>
        ...
        {
            var fieldCache = new RestFieldCache();
            ...
            if (InputTranslation != null)
            {
                try
                {
                    RestFieldCache translated = (RestFieldCache)InputTranslation.Translate(new StringInput(input.InputStream));
