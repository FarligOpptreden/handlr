...
namespace Handlr.Framework.Routing.Loaders
{
    ...
    /// </summary>
    public class TransformLoaderArguments : TranslationLoaderArguments
    {
        /// <summary>
        ...
        public TransformLoaderArguments(string absolutePath, string relativePath, XElement configuration) : base(absolutePath, relativePath, configuration)
        {
