...
namespace Handlr.Framework.Routing.Loaders
{
    ...
    /// </summary>
    public class XsltTransformLoaderArguments : TranslationLoaderArguments
    {
        /// <summary>
        ...
        public XsltTransformLoaderArguments(string absolutePath, string relativePath, XElement configuration) : base(absolutePath, relativePath, configuration)
        {
