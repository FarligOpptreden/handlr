...
namespace Handlr.Framework.Routing.Steps
{
    ...
    /// </summary>
    [Tag("Transform")]
    public class JsonTransform : Transform
    {
        /// <summary>
        /// Creates a new Transform instance.
        /// </summary>
        /// <param name="executionContext">The current execution context of the step</param>
        public JsonTransform(IController executionContext) : base(executionContext) { }
        ...
        public override IFieldCache ExecuteStep(IFieldCache fieldCache)
        {
            ...
            var loaderInstance = new Loaders.TransformLoaderArguments(LoaderArguments.AbsolutePath, LoaderArguments.RelativePath, LoaderArguments.Configuration);
